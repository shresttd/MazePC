...
/**
 * Tests the WallFollower algorithm
 * @author TJ
 *
 */
public class WallFollowerTest {
	...
	public void setUp() throws Exception {
		controller = new FakeController(Builder.DFS, new WallFollower(), 3, true) ;		//builder, driver, skill, perfect
	 ...
	 * Using the WallFollower algorithm
