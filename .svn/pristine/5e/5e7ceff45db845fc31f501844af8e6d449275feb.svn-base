...
public class MapDrawer extends DefaultViewer {
	...
	private final static Logger logDrawer = Logger.getLogger(MapDrawer.class.getName());
	...
	public void draw_map(MazePanel panel, int px, int py, int walk_step, int view_dx, int view_dy, boolean showMaze, boolean showSolution) {
		...
		//panel.getBufferGraphics().setColor(Color.white);
		panel.setColorGraphics("White");
		...
		for (int y = ymin; y <= ymax; y++)
			for (int x = xmin; x <= xmax; x++) {
				...
				//panel.getBufferGraphics().setColor(seencells.hasWall(x,y, CardinalDirection.North) ? Color.white : Color.gray);
				panel.setColorGraphics(seencells.hasWall(x,y, CardinalDirection.North) ? "White" : "Gray");
				...
				//panel.getBufferGraphics().setColor(seencells.hasWall(x,y, CardinalDirection.West) ? Color.white : Color.gray);
				panel.setColorGraphics(seencells.hasWall(x,y, CardinalDirection.West) ? "White" :"Gray");
	...
	public void draw_currentlocation(MazePanel panel, int view_dx, int view_dy) {
		...
		//panel.getBufferGraphics().setColor(Color.red);
		panel.setColorGraphics("Red");
	...
	public void draw_solution(MazePanel panel, int offx, int offy, int px, int py) {
		...
		//panel.getBufferGraphics().setColor(Color.yellow);
		panel.setColorGraphics("Yellow");
